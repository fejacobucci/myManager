...
module.exports = function awaitTag(input, out) {
  ...
  if (asyncValue.v_) {
    renderContents(asyncValue.t_, asyncValue.s_, input, out);
    return;
  }
  ...
  if (clientReorder) {
    ...
    clientReorderContext = out.global.z_ || (out.global.z_ = {
      instances: [],
      nextId: 0
    });
